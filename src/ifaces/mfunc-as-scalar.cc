...
/*
 * Scalar interface for functions
 */
...
struct hdql_ScalarFuncArgs {
    struct hdql_Query ** args;
};

static hdql_Datum_t
_arith_func_scalar_interface_instantiate(
...
static hdql_Datum_t
_arith_func_scalar_interface_dereference(
          hdql_Datum_t root
        , hdql_Datum_t dd_
...
static hdql_Datum_t
_arith_func_scalar_interface_reset(
...
static void
_arith_func_scalar_interface_destroy(
          hdql_Datum_t dd_
        , const hdql_Datum_t defData
        , hdql_Context_t ctx
        ) {
...
const struct hdql_ScalarAttrInterface _hdql_gScalarFwdQueryIFace = {
    ...
    .instantiate = _arith_func_scalar_interface_instantiate,
    .dereference = _arith_func_scalar_interface_dereference,
    .reset = _arith_func_scalar_interface_reset,
    .destroy = _arith_func_scalar_interface_destroy
};
